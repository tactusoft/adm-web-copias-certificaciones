...
@Named("certificadoDISBean")
@ViewScoped
public class CertificadoDISBean extends BeanBase implements Serializable {

    private static final long serialVersionUID = 1206022448771030512L;
    ...
    private final int numMaxSolicitudes = 15;

    public int getNumMaxSolicitudes() {
        return numMaxSolicitudes;
    }

    public CertificadoDISBean() throws Exception {
        super(TipoTramite.CERTIFICADO_SANCIONES);
    }
